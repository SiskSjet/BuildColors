...
namespace Sisk.BuildColors.UI {
    ...
    internal static class Style {
        ...
        // Colors are declared before the formats that consume them. Static field initializers run in
        // declaration order, so a format declared above its color would silently be built from
        // default(Color), which GlyphFormat coerces to black.
